...
_main:
    ...
    movq      rax, 0x2000004          ; 'write' syscall 4 + 0x20000000
    movq      rdi, 1                  ; fd=1=stdout
    movq      rsi, hello_world        ; cbuf
    movq      rdx, hello_world.len    ; nbyte
    syscall

    movq      rax, 0x2000001          ; 'exit' syscall 4 + 0x20000000
